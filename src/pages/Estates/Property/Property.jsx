...
const properties = [
  ...
  },
  {
    ...
    cat: "Luxury Homes",
    status: "For Sale",
    title: "5-Bedroom Clifftop Villa",
    ...
    features: ["Ocean View", "Infinity Pool", "Smart Home", "Private Gym"],
    tag: "Premium",
  },
  {
    id: "P14",
    ...
    features: ["Secure Estate", "Double Garage", "Garden", "Solar Panels"],
    tag: "Hot Listing",
  },
  {
    id: "P15",
    cat: "Commercial",
    status: "For Lease",
    title: "Prime Retail Corner — High Foot Traffic",
  ...
  },
  {
    ...
    cat: "Land & Plots",
    status: "For Sale",
    title: "Winelands Farm Plot — Title Deed",
    ...
    features: ["Title Deed", "Mountain Views", "Fertile Soil", "Borehole"],
    tag: "C of O",
  },
  {
    id: "P17",
    cat: "Residential",
    status: "For Rent",
    title: "3-Bedroom Townhouse — Gated Complex",
  ...
  },
  {
    ...
    cat: "Off-Plan",
    status: "Off-Plan",
    title: "Atlantic Quarters — 1 & 2 Bed Apartments",
    location: "Green Point, Cape Town",
    price: "From R 2,400,000",
    beds: "1–2",
    baths: "1–2",
    sqft: "55–110 sqm",
    image:
  ...
  },
  {
    ...
    cat: "Luxury Homes",
    status: "For Sale",
    title: "6-Bedroom Golf Estate Mansion",
    ...
    sqft: "900 sqm",
    image:
      "https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?auto=format&fit=crop&q=80&w=800",
    features: [
      "Golf Course View",
      "Wine Cellar",
      "Staff Quarters",
  ...
  },
  {
    ...
    cat: "Commercial",
    status: "For Sale",
    title: "Mixed-Use Development — Fully Tenanted",
...
const PropertyPage = () => {
  ...
  useEffect(() => {
    obs.current = new IntersectionObserver(
      (es) =>
        es.forEach(
          (e) => e.isIntersecting && e.target.classList.add("pr-visible"),
        ),
      { threshold: 0.08 },
    );
    document
      .querySelectorAll(".pr-reveal")
      .forEach((el) => obs.current.observe(el));
      ...
      <div className="pr-page">
        ...
        <section className="pr-hero">
          ...
          <div className="pr-hero__inner">
            ...
            <p className="pr-hero__sub">
              Residential, commercial, land, and luxury properties across Lagos
              and Abuja — each vetted, documented, and ready for seamless
              acquisition.
            </p>
          ...
          <div className="pr-hero__kpis">
            {[
              ["20+", "Active Listings"],
              ["Lagos, Abuja & South Africa", "Locations"],
              ["C of O", "Verified Titles"],
              ["₦8M+", "Starting Price"],
            ].map(([n, l]) => (
                    ...
                    <div className="pr-card" key={p.id}>
                      ...
                      <div className="pr-card__img-wrap">
                        ...
                        {p.tag && (
                          <span
                            ...
                            style={
                              tc ? { background: tc.bg, color: tc.color } : {}
                            }
                          >
                            {p.tag}
                          </span>
                      ...
                      <div className="pr-card__body">
                        ...
                        <div className="pr-card__features">
                          {p.features.map((f) => (
                            <span key={f} className="pr-card__feature">
                              ✓ {f}
                            </span>
                          ))}
                        </div>
                        ...
                        <div className="pr-card__foot">
                          ...
                          <a
                            href="/estates/contact"
                            className="pr-card__cta-sec"
                          >
                            Book Viewing
                          </a>
                        </div>
        ...
        <section className="pr-cta pr-reveal">
          <div className="pr-cta__inner">
            ...
            <p>
              Our property consultants have access to off-market listings,
              upcoming developments, and a wide network of verified vendors
              across Nigeria. Share your requirements and we'll find your match.
            </p>
            <div className="pr-cta__btns">
              <a href="/contact" className="pr-btn pr-btn--gold">
                Submit Property Brief
              </a>
              <a href="/why-us" className="pr-btn pr-btn--outline-lt">
                Why Bravelion Estates
              </a>
            </div>
          </div>
        </section>
