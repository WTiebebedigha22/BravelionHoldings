      ...
      <div className="content-container">
        ...
        <section className="intro-section">
          <div className="intro-grid">
            ...
            <div className="intro-side">
              ...
              <p className="side-p">
                From land acquisition to turnkey delivery, we ensure
                every development reflects quality, sustainability,
        ...
        <section className="highlights-section">
          <div className="highlight-row">
            ...
            <div className="highlight-text">
              ...
              <p>
                Our developments prioritize functionality,
                aesthetics, and community growth — delivering
                spaces where people thrive and businesses grow.
              </p>
          ...
          <div className="highlight-row reverse">
            <div className="highlight-text">
              ...
              <p>
                We identify high-growth locations and structure
                projects that maximize capital appreciation
                and rental yield.
              </p>
        ...
        <section className="qhse-banner">
          <div className="qhse-content">
            ...
            <p>
              Our commitment to structural integrity, compliance,
              and sustainable design ensures long-term value for
              homeowners and investors alike.
            </p>
            <a
              href="/about"
              className="pwr-btn pwr-btn-outline-white"
            >
        ...
        <section className="final-cta">
          <div className="cta-inner">
            ...
            <p>
              Let’s help you secure a property that grows
              in value and impact.
            </p>
            ...
            <div className="cta-buttons">
              ...
              <a
                href="/contact"
                className="pwr-btn pwr-btn-ghost"
              >
                Speak to Sales
              </a>
            </div>
