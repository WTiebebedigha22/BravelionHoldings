...
import { Mail, Phone, Menu, X, ArrowUpRight, Zap } from "lucide-react";
import "../../../../components/common/Navbar/navbar.css";

const energyLinks = [
  { label: "Oil & Gas Consultancy", to: "/energy/oil-gas-consultancy" },
  { label: "Energy Training", to: "/energy/energy-training" },
  { label: "Power Distribution & Solar", to: "/energy/power-distribution-solar" },
...
const EnergyNavbar = () => {
  ...
  return (
    ...
    >
      {/* ===== TOP BAR ===== */}
      <div className="topbar topbar--energy">
        <div className="container topbar__inner">
          <div className="topbar__contacts">
            <a
              href="mailto:energy@bravelionholdings.com"
              className="topbar__item"
            >
              <Mail size={11} strokeWidth={2.5} />
              energy@bravelionholdings.com
            </a>
          ...
          <span className="topbar__tagline">Power. Precision.</span>
        </div>
      </div>

      {/* ===== MAIN NAV ===== */}
      <nav className="navbar navbar--energy">
        <div className="container navbar__inner">
          ...
          <div className="navbar__end">
            <Link to="/contact" className="navbar__cta navbar__cta--energy">
      ...
      >
        ...
        <div className="mobile-drawer__foot">
          <Link
            to="/contact"
            className="mobile-drawer__cta mobile-drawer__cta--energy"
            onClick={() => setMenuOpen(false)}
          >
          ...
          <div className="mobile-drawer__contacts">
            <a
              ...
              className="topbar__item"
            >
              <Mail size={12} /> energy@bravelionholdings.com
            </a>
            <a href="tel:+2347081728260" className="topbar__item">
