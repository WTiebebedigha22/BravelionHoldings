...
const services = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1516841273335-e39b37888115?auto=format&fit=crop&q=80&w=800",
  },
];
...
const Services = () => {
  ...
  return (
    <div className="cert-page">
      ...
      {/* ===== HERO ===== */}
      <section className="services-hero sv-hero-custom">
        <div className="services-hero__overlay" />

        <div className="cert-container">
          <div className="services-hero__inner cert-reveal">
            <span className="cert-eyebrow light">Integrated Solutions</span>

            <h1>
              Multidisciplinary <br />
              <span className="cert-highlight">Engineering Excellence</span>
            </h1>

            <p className="services-hero__sub">
              Bravelion Holdings delivers engineering, energy, training, and
              business solutions across Africa with precision, compliance, and
              innovation.
            </p>

            <div className="cert-hero__actions">
              <a href="#services-grid" className="cert-btn-primary">
                Explore Services
              </a>

              <a href="/contact" className="cert-btn-outline">
                Contact Us
              </a>
            </div>
          </div>
                ...
                <div className="sv-card-content">
                  ...
                  <div className="sv-card-tags">
                    {service.tags.slice(0, 3).map((tag) => (
                      <span key={tag} className="sv-mini-tag">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <div className="cert-container">
          <div className="sv-standards-inner">
            <div className="sv-standards-text cert-reveal">
              ...
              <p>
                Every engagement is governed by rigorous QA/QC protocols and
                international safety benchmarks.
              </p>
              <a href="/contact" className="cert-btn-primary">
                Company Profile
              </a>
            </div>
            <div className="sv-standards-grid-cards">
              {[
                {
                  t: "Compliance",
                  d: "Aligned with national regulatory frameworks.",
                },
                {
                  t: "Quality Control",
                  d: "Structured QA processes on every project.",
                },
        ...
        <div className="cert-container">
          <div className="cert-cta__inner cert-reveal">
            <div className="cert-cta__text">
              ...
              <p>
                Let's discuss how our multidisciplinary team can support your
                objectives.
              </p>
            </div>
